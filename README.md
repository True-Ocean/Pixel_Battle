...
- BGM（設定で ON/OFF）、カードノート（プレミアム編集）、プレミアムはリネーム無料、デッキ名変更はサブスク会員限定  
- サブスク: ライト / プレミアム（月次一括受取・プロトタイプ課金 UI）  
- ヘルプ: バトルハブ / マイデッキ / 思い出アルバム / エディタ / バトル履歴の **?** モーダル  
...
- [x] 公開デッキ戦（旧「対人戦（オフライン）」・公開デッキ一覧・**戦力補正**） / Public deck battle (public decks + power-based BP rescale)  
