...
| 汎用限界突破 | `limitBreakUniversal` | **Lv20, 30, 40…** | 全属性で1回限界突破（保険・節目報酬） |
...
**完了条件**: 勝利→墓地選択→欠片が増える。2倍広告はまだ px のみ。
...
4. フェーズ **2b** — Lv5 未満ロスト無効・Lv5 到達時護符 ×1（[ECONOMY_SPEC §4.2.1](./ECONOMY_SPEC.md#421-初心者保護ユーザーレベル--5)）
