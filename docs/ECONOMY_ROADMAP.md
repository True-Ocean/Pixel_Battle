...
| ショップ画面 | ✅ **3タブ**（💎 / アイテム / サブスク）・モック購入・schema v7（**2026-06-20 完了**） |
...
3. ~~`SaveData.shopPurchase`~~ — **✅ 完了**（schema v7）
...
17. ~~フェーズ **8** — 3タブ ShopScreen~~ — **2026-06-20 完了**
...
- [x] **サブスク**: ライト **500円** / プレ **800円**。**排他**。ライト→プレ **日割り差額**（`ceil(300×残り比率)`）・月次差分も同比率。**年額 v1 なし**
