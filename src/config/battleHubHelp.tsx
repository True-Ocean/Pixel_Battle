  ...
  const sections: HelpTopic['sections'][number][] = [
    {
      ...
      items: [
        ...
        '準備画面で、自分のカードを前衛 2・後衛 3 に配置します（入れ替え可能です）。',
        `5 枚すべて配置すれば「準備完了」でバトル開始。未配置のまま 30 秒経過した場合は、残りをランダム配置して開始します。`,
      ],
    },
    {
      title: '1 ターンの操作',
    ...
    },
    {
      ...
      items: [
        ...
        '近接攻撃は、BP が大きい順に処理され、BP が同じ場合は属性順＞レア度順＞限界突破順＞ランダム順 に処理されます。',
