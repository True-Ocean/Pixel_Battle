...
export const ATTRIBUTE_META: Record<Attribute, AttributeMeta> = {
  ...
  heal: {
    label: '癒',
    ariaName: '癒属性',
    description: 'デバフを持つ対象のデバフを治癒\nデバフのない対象のBPを回復\n（治癒・回復は2回まで）',
    battleGuide: [
      '・後衛時：自分か味方を治癒または回復する',
      '・前衛時：近接攻撃または、自分か味方を治癒または回復',
      '・治癒：デバフを持つ対象のデバフ（毒、凍結）を解除する',
      '・回復：デバフを持たない対象のBPを回復する',
      '　（自分の現BP分を回復、ただし対象の最大BPを超えない）',
      '・治癒・回復は1枚あたり2回まで',
      '・治癒・回復は、毒ダメージの後、盾付与・攻撃より先に処理される',
    ].join('\n'),
    bg: '#44cc88',
    border: '#22aa66',
  },
  ...
  storm: {
    ...
    ariaName: '嵐属性',
    description:
      '2体のランダムな敵にダメージ。ステルス中の忍もあぶり出せる\n（バトル中2回まで）',
    battleGuide: [
      '・後衛：嵐カードを2回タップで発動',
      '・前衛：嵐は自分を再タップ、近接は敵前衛をタップ',
      '・嵐は、自分のBPの50%のダメージを2体のランダムな敵に与える（バトル中2回まで）',
      '・ステルス中の忍にも当たり、ステルスを解除できる',
      '・嵐による攻撃は反撃を受けない',
    ].join('\n'),
    bg: '#8888cc',
    border: '#6666aa',
