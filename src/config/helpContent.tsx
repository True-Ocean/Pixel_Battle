  ...
  return {
    ...
    sections: [
      ...
      },
      {
        title: '4. 並べ替え',
        items: [
          'カードを長押しすると、そのままドラッグして並べ替えできます。',
          '同じデッキ内では並び順を変えられます。',
          '他のデッキタブへドラッグすると縮小カードになり、そのデッキのカードの上に重ねて離すと入れ替えます。空きスロットへ重ねると移動します。タブ上で離すと空きスロットへ自動配置され、満杯のときはキャンセルされます。',
          '指を離すと並べ替えが確定します。',
        ],
      },
    ],
  ...
  return {
    ...
    sections: [
      ...
      },
      {
        title: '2. カードの保存',
        items: [
          'マイデッキのカード詳細からアルバムアイコン付きの「に移動」で移動できます（無料）。',
        ],
      },
      {
        title: '3. カードの閲覧',
    ...
    sections: [
      ...common,
      {
        ...
        items: [
          ...
          'カードを編集しても、属性は変わりません。属性を変更するには、カード詳細の属性ガチャを使います。',
